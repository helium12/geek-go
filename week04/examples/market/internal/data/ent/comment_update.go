...
func (cu *CommentUpdate) SetDesc(s string) *CommentUpdate {
...
func (cu *CommentUpdate) SetPost(a *Product) *CommentUpdate {
...
// SetDesc sets the "desc" field.
func (cuo *CommentUpdateOne) SetDesc(s string) *CommentUpdateOne {
...
// SetPost sets the "post" edge to the Product entity.
func (cuo *CommentUpdateOne) SetPost(a *Product) *CommentUpdateOne {
