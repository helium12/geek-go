...
func (tu *TagUpdate) AddPosts(a ...*Product) *TagUpdate {
...
func (tu *TagUpdate) RemovePosts(a ...*Product) *TagUpdate {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// AddPosts adds the "posts" edges to the Product entity.
func (tuo *TagUpdateOne) AddPosts(a ...*Product) *TagUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
// RemovePosts removes "posts" edges to Product entities.
func (tuo *TagUpdateOne) RemovePosts(a ...*Product) *TagUpdateOne {
	ids := make([]int64, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
